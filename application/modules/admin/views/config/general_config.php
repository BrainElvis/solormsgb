...
<div id="config_wrapper">
    <fieldset id="config_info">
        ...
        <div class="form-group form-group-sm">	
            <?php echo form_label($this->lang->line('config_vatreg'), 'vatreg', array('class' => 'control-label col-xs-2 required')); ?>
            <div class="col-xs-6">
                <div class="input-group">
                    <span class="input-group-addon input-sm"><span class="glyphicon glyphicon-signal"></span></span>
                    <?php
                    echo form_input(array(
                        'name' => 'vatreg',
                        'id' => 'vatreg',
                        'class' => 'form-control input-sm required',
                        'value' => $this->config->item('vatreg')));
                    ?>
                </div>
            </div>
        </div>
                ...
                <div class="fileinput <?php echo isset($logo_exists) ? 'fileinput-exists' : 'fileinput-new'; ?>" data-provides="fileinput">
                    ...
                    <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 200px;">
                        <img data-src="holder.js/100%x100%" alt="<?php echo $this->lang->line('config_company_logo'); ?>"
                             src="<?php if (isset($logo_exists)) echo base_url('uploads/' . $this->Appconfig->get('company_logo'));
            else echo ''; ?>"
            ...
            messages:
                    {
                        ...
                        vatreg: "<?php echo $this->lang->line('config_vatreg_required'); ?>",
