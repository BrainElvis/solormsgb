...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo ASSETS_ADMIN_CSS_PATH ?>icheck/flat/green.css" rel="stylesheet">
        <!-- ion_range -->
        <link rel="stylesheet" href="<?php echo ASSETS_ADMIN_CSS_PATH ?>/normalize.css" />
        <link rel="stylesheet" href="<?php echo ASSETS_ADMIN_CSS_PATH ?>ion.rangeSlider.css" />
        <link rel="stylesheet" href="<?php echo ASSETS_ADMIN_CSS_PATH ?>ion.rangeSlider.skinFlat.css" />
        <!-- colorpicker -->
        <link href="<?php echo ASSETS_ADMIN_CSS_PATH ?>colorpicker/bootstrap-colorpicker.min.css" rel="stylesheet">
        ...
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>progressbar/bootstrap-progressbar.min.js"></script>
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>nicescroll/jquery.nicescroll.min.js"></script>
        <!-- icheck -->
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>icheck/icheck.min.js"></script>
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>custom.js"></script>
        <!-- daterangepicker -->
        <script type="text/javascript" src="<?php echo ASSETS_ADMIN_JS_PATH ?>moment/moment.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_ADMIN_JS_PATH ?>datepicker/daterangepicker.js"></script>
        <!-- input mask -->
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>input_mask/jquery.inputmask.js"></script>
        <!-- knob -->
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>knob/jquery.knob.min.js"></script>
        <!-- range slider -->
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>ion_range/ion.rangeSlider.min.js"></script>
        <!-- color picker -->
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>colorpicker/bootstrap-colorpicker.min.js"></script>
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>colorpicker/docs.js"></script>

        <!-- image cropping -->
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>cropping/cropper.min.js"></script>
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>cropping/main2.js"></script>
        <!-- pace -->
        <script src="<?php echo ASSETS_ADMIN_JS_PATH ?>pace/pace.min.js"></script>
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile">
                            <div class="profile_pic">
                                <img src="<?php echo ASSETS_ADMIN_IMAGE_PATH ?>img.jpg" alt="..." class="img-circle profile_img">
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            ...
                                            <div class="img-container">
                                                <img src="<?php echo ASSETS_ADMIN_IMAGE_PATH ?>picture2.jpg" alt="Picture">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
